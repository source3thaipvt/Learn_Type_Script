export {};
// Alias type  // line 177
// neu co nhieu type giong nhau thi tao: type = type? ... de tai su dung
// giong voi interface: deu tai su dung
enum PetType {
  Dog,
  Cat,
  Bird,
...
type SpecialContact = { name: string; phone: number };
...
function isLastDateOfMonth(date: MixedDate): boolean {
  return false;
}
